...
<html lang="en">
<?php
$title = "Survival Frog Affiliate: Privacy Policy";
...
<section class="container body survival-frog-article">
    ...
    <article class="content">
        ...
        <section class="paragraph">
            <p>
                If there are any questions regarding this privacy policy you may contact us using the information found at this link: http://SurvivalFrog/About-Us_ep_54-1.html
            </p>
        </section>
        <address>
            4155 E. Jewell St.<br>
        ...
        <section class="paragraph">
            <p>
                <a href="mailto:#">support@SurvivalFrog.com</a><br>
                <abbr title="Phone">(800) 773-7737</abbr><br>
            </p>
        </section>
        <section class="paragraph">
            <p>
