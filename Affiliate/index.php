    ...
    <section class="left-tabpanel" role="tabpanel" id="left-tabpanel">
        ...
        <section class="tab-content right-tab-content">
            <article class="content home-page">
                ...
                <p>If you are an affiliate driving traffic, or a product owner looking for complementary products, Survival Frog
                    is your 1 stop source for hundreds of top selling survival products.</p>
                <h4>E-Commerce: </h4>

                <p>SurvivalFrog.com has hundreds of survival products to choose from with average cart value over $90. As an
                    affiliate you can send buyers to the e-commerce Home page, Category page or specific product pages and you
                ...
                <p>For select survival gear we also offer DRM pages with upsells. If you would rather your buyers see a
                    dedicated sales page with no other distractions, then checkout one of our top selling survival gear pages.
                    We use Infusionsoft for affiliate tracking.</p>
                <h4>Info Products:</h4>

                <p>Our sister company, Peak 10 Publishing, LLC has a wide selection of info products in the Survival and Self
                    Reliance niches.</p>
