...
<html lang="en">
<?php
$title = "Survival Frog Affiliate: Terms & Conditions";
...
<section class="container body survival-frog-article">
    ...
    <article class="content">
        <section class="title">
            <h4>TERMS OF USE AND DMCA NOTICE</h4>
            <h5>Effective Date: December 11, 2013</h5>
        </section>
        <section class="paragraph">
            ...
            <p>
                1. Parties. The parties to these Terms of Use are you, and the owner of this SurvivalFrog.com website business, Survival Frog LLC ("Survival Frog").  All references to "we", "us", "our", this "website" or this "site" shall be construed to mean this website business and Survival Frog.
            </p>
        </section>
        <section class="paragraph">
            <p>
        ...
        <section class="paragraph">
            ...
            <address>
                <strong>Notification of Claimed Infringement:</strong>
                <br>
                Survival Frog LLC<br>
                4155 E. Jewell St.<br>
                Suite 900<br>
                Denver, CO 80222<br>
                Agent's Name/Email Address: support@SurvivalFrog.com<br>
                <abbr title="Phone">Telephone:</abbr> (800) Prepper
            </address>
            <p>
        ...
        <section class="paragraph">
            ...
            <address>
                ...
                Suite 900<br>
                Denver, CO 80222<br>
                Contact: support@SurvivalFrog.com<br>
                <abbr title="Phone">Telephone:</abbr> (800) Prepper<br>
            </address>
            <p>
        ...
        <section class="paragraph">
            <p>
                The Complaint Assistance Unit of the Division of Consumer Services of the Department of Consumer Affairs may be contacted in writing at 1020 N. Street, #501, Sacramento, CA 95814, or by telephone at1-916-445-1254 .
            </p>
        </section>
        <section class="paragraph">
            <p>
        ...
        <section class="paragraph">
            <p>
                Material Modifications Since December 11, 2013: NONE
            </p>
        </section>
    </article>
</section>
